...
void ABlasterCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Equip", IE_Pressed, this, &ABlasterCharacter::EquippedButtonPressed);
...
// We know this is on server since server RPC only happens on server
